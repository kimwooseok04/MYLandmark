        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(str_id.length()<5||str_pw.length()<8){
                    Toast.makeText(MainActivity.this, "아이디와 비밀번호의 길이를 확이하세요", Toast.LENGTH_SHORT).show();
                }else{

                    if(str_id.equals("30404") && str_pw.equals("12345678")) {
                        Toast.makeText(MainActivity.this, "환영합니다", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(MainActivity.this, "아이디와 비밀번호를 확인세요", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
